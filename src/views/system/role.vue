    ...
    <div>
        <el-card>
            <el-row>
                ...
                <el-col :span="2">
                    <el-button @click="insert" type="primary" style="margin-left: 10px" v-hasPermi="['PRE_USER_INSERT']">添加信息</el-button>
                </el-col>
            </el-row>
            <el-table :data="tableList" stripe >
                ...
                <el-table-column fixed="right" label="操作" width="150">
                    <template slot-scope="scope">
                        <el-button type="primary" @click="update(scope.row)"  v-hasPermi="['PRE_USER_UPDATE']" size="small" icon="el-icon-edit" circle></el-button>
                        <el-button type="danger" @click="deleteById(scope.row.id)"  v-hasPermi="['PRE_USER_DELETE']" size="small" icon="el-icon-delete" circle></el-button>
                    </template>
                </el-table-column>
            </el-table>
